<%-- 
    Document   : listar
    Created on : 3 oct. 2020, 13:47:35
    Author     : cesar4rroyo
--%>
                        ...
                        <div class="container mt-5 text-center" >
                            <div class="table-responsive">
                                <table class="table table-hover" >
                                    ...
                                    <%
                                        daoEstadoPed dEst = new daoEstadoPed();
                                        List<beanEstadoPed> lisEst = dEst.listar();
                                        Iterator<beanEstadoPed> iter = lisEst.iterator();
                                        beanEstadoPed bEst = null;
                                        while (iter.hasNext()) {
                                            bEst = iter.next();
                                    %>
                                    <tbody>
                                        <tr>                                            
                                            <td><%= bEst.getId_Estado_pedido()%></td>
                                            <td><%= bEst.getNombre_estado()%></td>
                                        </tr>
                                        <%}%>
                                    </tbody>
                                </table>
