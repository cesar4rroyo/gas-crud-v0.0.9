...
<html lang="en">
    ...
    <body>
        <h1 class="text-center pt-5"> COMPRA  </h1> 
        <hr>
        <div class="container first">  
            <div class="row"> 
                <div class="col card mt-5 border border-warning "> 
                    <form action="reportes\repCompras\comprasPdf.jsp" method="post" >
                        <div class="text-center pt-3">
                            <h2 class="font-weight-bold">Generar Reporte PDF </h2> 
                            <hr>
                        </div>
                        <div class="form-group" >
                            <label  >Base de Datos Compras</label>
                        </div>
                        <td>
                ...
                <div class="col card mt-5 border border-info">
                    <form action="reportes\repCompras\comprasParaPdf.jsp" method="post" >
                        <div class="text-center pt-3">
                        ...
                        <%
                            ...
                            List<beanCompra> list = dao.listarCompras();
                        %>
                        <select class="form-control mb-2" id="control" name="control">
                            <option>Seleccione una opcion</option>
                            <% for (beanCompra i : list) {%>                                                    
                            <option value="<%=i.getId_Compra()%>">
                                <%=i.getProvedor().getNombre()%>
                            </option>
                            <% }%>
                        </select>
                ...
                <div class="col card mt-5 border border-success">
                    <form action="reportes\repCompras\comprasExcel.jsp" method="post" >
                        <div class="text-center pt-3">
                ...
                <div class="col card mt-5 border border-primary">
                    <form action="reportes\repCompras\comprasParaExcel.jsp" method="post" >
                        <div class="text-center pt-3">
