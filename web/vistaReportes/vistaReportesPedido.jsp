...
<html lang="en">
    ...
    <body>
        <h1 class="text-center pt-5"> PEDIDO  </h1> 
        <hr>
        <div class="container first">  
            <div class="row"> 
                <div class="col card mt-5 border border-warning "> 
                    <form action="reportes\repPedido\pedidoPdf.jsp" method="post" >
                        <div class="text-center pt-3">
                            <h2 class="font-weight-bold">Generar Reporte PDF </h2> 
                            <hr>
                        </div>
                        <div class="form-group" >
                            <label  >Base de Datos Pedido</label>
                        </div>
                        <td>
                ...
                <div class="col card mt-5 border border-info">
                    <form action="reportes\repPedido\pedidoParaPdf.jsp" method="post" >
                        <div class="text-center pt-3">
                        ...
                        <select class="form-control mb-2" id="control" name="control">
                            ...
                            <% for (beanPedido i : list) {%>                                                    
                            <option value="<%=i.getId_Pedido()%>">
                                <%=i.getId_Pedido()%>
                            </option>
                            <% }%>
                        </select>
                ...
                <div class="col card mt-5 border border-success">
                    <form action="reportes\repPedido\pedidoExcel.jsp" method="post" >
                        <div class="text-center pt-3">
                ...
                <div class="col card mt-5 border border-primary">
                    <form action="reportes\repPedido\pedidoParaExcel.jsp" method="post" >
                        <div class="text-center pt-3">
