<%-- 
    Document   : editCompra
    Created on : 30 oct. 2020, 17:37:01
    Author     : cesar4rroyo
--%>
                    ...
                    <div class="container" >
                        ...
                        <div class="container mt-5 text-center" >
                            <%
                                ...
                                int idCompra = Integer.parseInt((String) request.getAttribute("id"));
                                beanCompra bCompra = (beanCompra) dao.list(idCompra);
                            %>
                            <form action="editCompra" >
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="txtProvedor" name="txtProvedor" class="form-control" required>
                                            <option value="<%=bCompra.getProvedor().getId_Provedor()%>">Seleccione una opcion</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="txtProducto" name="txtProducto" class="form-control" required>
                                            <option value="<%=bCompra.getProducto().getId_Producto()%>">Seleccione una opcion</option>
                                    ...
                                    <div class="row" >
                                        <div class="form-group col-md">
                                            ...
                                            <input type="hidden" name="txtCantidadDefecto" value="<%=bCompra.getCantidad()%>">
                                            <input value="<%=bCompra.getCantidad()%>" class="form-control" type="number" placeholder="Cantidad"  name="txtCantidad" id="txtCantidad" required="" autocomplete="off" >
                                        </div> 
                                        <div class="form-group col-md">
                                            <label for="txtTotal">Total:  </label>
                                            <input value="<%=bCompra.getTotal()%>" class="form-control" type="number" name="txtTotal" placeholder="Total"  required="" id="txtTotal" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="txtIdCompra" value="<%=bCompra.getId_Compra()%>">
                                <div class="container mt-3">
                                    <input class="btn btn-success" type="submit"  id="btnAgregar" name="accion" value="Actualizar">
                                    <a class="btn btn-secondary" href="listCompra">Regresar</a>  
                                </div>  
                            </form>
                        </div>
