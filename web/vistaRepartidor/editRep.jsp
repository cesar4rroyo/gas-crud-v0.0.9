<%-- 
    Document   : editRep
    Created on : 01-oct-2020, 11:23:17
    Author     : ROG STRIX
--%>
                ...
                <div id="content">
                    ...
                    <div class="container col-md-6 mt-5" >
                        ...
                        <form action="controladorRep">
                            Nombres: <br>
                            <input class="form-control" type="text" name="txtNomRep" value="<%= bR.getNombre()%>"><br>
                            Apellidos <br>
                            <input class="form-control" type="text" name="txtApeRep" value="<%= bR.getApeliido()%>"><br>
                            Telefono <br>
