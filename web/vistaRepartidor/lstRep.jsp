<%-- 
    Document   : lstRep
    Created on : 01-oct-2020, 11:23:28
    Author     : ROG STRIX
--%>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row" >
                                                <div class="form-group col-md">
                                                    <label for="txtRuc">Nombre: </label>
                                                    <input class="form-control" type="text" placeholder="Nombre"  name="txtNomRep" id="txtRuc" autocomplete="off" required >
                                                </div> 
                                                <div class="form-group col-md">
                                                    <label for="txtTelefono">Apellido:  </label>
                                                    <input class="form-control" type="text" name="txtApeRep" placeholder="Apellido" id="txtTelefono" autocomplete="off" required>
                                                </div>
                                            </div> 
                                            <div class="row" >
                                                <div class="form-group col-md">
                                                    <label for="txtRuc">Teléfono: </label>
                                                    <input class="form-control" type="number" placeholder="Nro. Teléfono"  name="txtTelRep" id="txtRuc" autocomplete="off" required >
                                                </div> 
                                                <div class="form-group col-md">
                                                    <label for="dni">DNI:  </label>
                                                    <input class="form-control" type="number" name="txtDniRep" placeholder="Nro. de DNI"  id="dni" autocomplete="off" required>
                                                </div>
                                            </div> 
                                ...
                                <table class="table table-hover" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th align="col">Acciones</th>                           
                                        </tr>
                                    </thead>
                                    <%
                                        daoRepartidor dRep = new daoRepartidor();
                                        List<beanRepartidor> lstRep = dRep.listarRep();
                                        Iterator<beanRepartidor> iter = lstRep.iterator();
                                        beanRepartidor bRep = null;
                                        while (iter.hasNext()) {
                                            bRep = iter.next();
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><%= bRep.getNombre()%></td>
                                            <td><%= bRep.getApeliido()%></td>
                                            <td><%= bRep.getTelefono()%></td>
                                            <td><%= bRep.getDni()%></td>
                                            <td><%= bRep.getId_Transporte()%></td>                                            
                                            <td>
                                                <div class="btn-group" >
                                                    <a class="btn btn-primary"  href="controladorRep?accion=editarR&idR=<%= bRep.getId_Repartidor()%>">
