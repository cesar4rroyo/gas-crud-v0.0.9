<%-- 
    Document   : edit
    Created on : 29-sep-2020, 11:12:53
    Author     : ROG STRIX
--%>
                ...
                <div class="container-fluid d-flex flex-column p-0">
                    ...
                    <ul class="nav navbar-nav text-light" id="accordionSidebar">
                        <li class="nav-item" role="presentation">
                            ...
                            <a class="nav-link active" href="index.html"
                               ><i class="fas fa-truck-alt"></i><span>PROVEEDORES</span>
                            </a>
                            <a class="nav-link active" href="index.html"
                               ><i class="fas fa-male-alt"></i><span>REPARTIDORES</span>
                            </a>
                            <a class="nav-link active" href="index.html"
                               ><i class="fas fa-list-alt"></i><span>ESTADOS PEDIDO</span>
                            </a>
                            <a class="nav-link active" href="index.html"
                               ><i class="fas fa-bicycle-alt"></i><span>TRANSPORTE</span>
                            </a>
                        </li>
                    ...
                    <div class="container col-md-6 mt-5" >
                        <div class="text-center">
                            <%
                                ...
                                int idProv = Integer.parseInt((String) request.getAttribute("idProv"));
                                beanProveedor bP = (beanProveedor) dProv.list(idProv);
                            %>
                        ...
                        <form action="Controlador">
                            Nombres: <br>
                            <input class="form-control" type="text" name="txtNom" value="<%=bP.getNombre()%>"><br>
                            Ruc <br>
                            <input class="form-control" type="text" name="txtRuc" value="<%=bP.getRuc()%>"><br>
                            Telefono <br>
                            <input class="form-control" type="text" name="txtTel" value="<%=bP.getTelefono()%>"><br>
                            Direccion <br>
                            <input class="form-control" type="text" name="txtDir" value="<%=bP.getDireccion_provedor()%>"><br>

                            <input type="hidden" name="txtId" value="<%=bP.getId_Provedor()%>">
