<%-- 
    Document   : listarPdto
    Created on : 01/10/2020, 11:32:10 AM
    Author     : USER
--%>
                                ...
                                <div class="modal-content">
                                    <form action="controladorPdto" >
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label for="txtDireccion">Descripción: </label>
                                                <input class="form-control" type="text" name="txtDescripcion" placeholder="Descripción"  id="txtDireccion" required autocomplete="off">
                                            </div>
                                            <div class="row" >
