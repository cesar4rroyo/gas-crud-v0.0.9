...
<html>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="fechaInicio" ><%=bp.getFecha_inicio()%></td>
                                            <td>
                                                <div class="btn-group" >
    ...
    <script>
        ...
        const fechaInicio = document.getElementsByClassName("fechaInicio");
        const cargarFechas = () => {
            for (i = 0; i < fechaInicio.length; i++) {
                var date = new Date(fechaInicio[i].innerHTML);
                moment.locale('es');
                var newdate = moment(date).format('MMMM Do YYYY, h:mm:ss a');
                fechaInicio[i].innerHTML = newdate;
            }
        };
    </script>
</html>
