...
<html lang="en">
    ...
    <body>
        <h1 class="text-center pt-5"> TRANSPORTE </h1> 
        <hr>
        <div class="container first">  
            <div class="row"> 
                <div class="col card mt-5 border border-warning "> 
                    <form action="reportes\repTransporte\transPdf.jsp" method="post" >
                        <div class="text-center pt-3">
                            <h2 class="font-weight-bold">Generar Reporte PDF </h2> 
                            <hr>
                        </div>
                        <div class="form-group" >
                            <label  >Base de Datos Transporte</label>
                        </div>
                        <td>
                ...
                <div class="col card mt-5 border border-info"> 
                    <form action="reportes\repTransporte\transParaPdf.jsp" method="post" >
                        <div class="text-center pt-3">
                        ...
                        <%
                            ...
                            List<beanTransporte> list = dao.listarTrp();
                        %>
                        <select class="form-control mb-2" id="control" name="control">
                            <option>Seleccione una opcion</option>
                            <% for (beanTransporte i : list) {%>                                                    
                ...
                <div class="col card mt-5 border border-success">
                    <form action="reportes\repTransporte\transExcel.jsp" method="post" >
                        <div class="text-center pt-3">
                ...
                <div class="col card mt-5 border border-primary">
                    <form action="reportes\repTransporte\transParaExcel.jsp" method="post" >
                        <div class="text-center pt-3">
